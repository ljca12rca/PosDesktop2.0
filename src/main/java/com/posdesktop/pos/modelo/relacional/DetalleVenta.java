...
public class DetalleVenta extends EntidadAuditable {
    ...
    public static DetalleVenta crearDetalleManual(int orden, String descripcion, BigDecimal valorTotal) {
        ...
        detalle.setPrecioUnitario(valorTotal);
        detalle.setSubtotal(valorTotal);
        detalle.setDescuento(BigDecimal.ZERO);
        detalle.setImpuesto(BigDecimal.ZERO);
        detalle.setTotal(valorTotal);
        return detalle;
    }
